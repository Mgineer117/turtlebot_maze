...
All the environments are registered in the `turtlebot` extension. They start
...
import turtlebot.tasks  # noqa: F401


def main():
    """Print all environments registered in `turtlebot` extension."""
